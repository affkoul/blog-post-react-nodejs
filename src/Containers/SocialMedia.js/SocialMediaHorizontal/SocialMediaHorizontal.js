            ...
            <div className="footer-icons">
                <ul className="navbar-nav ">
                    <li className="nav-item inline-block">
                        <a href="https://hlwsdtech.com" aria-label="Github" className="nav-link text-github">
                    ...
                    <li className="nav-item inline-block">
                        <a href="https://ndolet.com" aria-label="Insagram" className="nav-link">
                            <i className="fa fa-instagram"></i>
                        </a>
                    </li>

                    <li className="nav-item inline-block">
                        <a href="https://hlwsdtech.com" aria-label="LinkedIn" className="nav-link">
