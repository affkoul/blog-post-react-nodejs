                    ...
                    {this.props.match.path === "/mypost/:id" &&
                        <div className="col-md-3 col-xs-12 ">
                            <div className="list-group">
                                <Link to={"/edit/" + post1._id} className="list-group-item list-group-item-action">编辑</Link>
                                <button type="button" onClick={this.showModal} className="list-group-item list-group-item-action">删除</button>
                            </div>
                        </div>}
                    <div className="col-md-9 col-xs-12 main">
                        <Modal show={this.state.show} handleClose={this.hideModal}>
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-danger" onClick={() => this.deletePost(post1._id)}>删除 </button>
                                <button type="button" className="btn btn-outline-dark" onClick={this.hideModal} data-dismiss="modal">关闭</button>
                            </div>
                        </Modal>
                        {post}
                    </div>
