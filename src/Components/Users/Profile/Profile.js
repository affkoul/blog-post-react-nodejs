    ...
    render() {
        ...
        return (
            <>
                ...
                <div className="container py-5 container-short">
                    <div className="row profile">
                        <div className="col-md-8 col-xs-12 order-2 order-lg-1">
                            ...
                            {(!storedData && path !== "/profile") ? null : <Link to={"/profile/edit/" + profile._id}  >编辑个人信息</Link>}
                            <p>{profile.bio}</p>
                        </div>
                ...
                <div className="container py-5 container-short">
                    <h2 className="font-weight-light text-black">{profile.username}的发布</h2>
                    <hr />
                    {this.state.posts.length === 0 ? <h2 className="mt-5 text-center">无发布</h2> : null}
                    <div className="row">
                        {fetchedposts}
                    </div>
